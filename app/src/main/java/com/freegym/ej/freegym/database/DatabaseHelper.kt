...
class DatabaseHelper(context: Context, DB_PATH: String, DB_NAME: String) : SQLiteOpenHelper(context, DB_NAME, null, 1) {

    private var DB_PATH: String = DB_PATH
    private var DB_NAME: String = DB_NAME
...
////    }
//    init {
////        database = GymDatabase(context, "gym.db", "/assets/databases/gym.db", null, 1)
